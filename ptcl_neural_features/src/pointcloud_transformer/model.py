...
from pointcloud_transformer.module import Embedding, NeighborEmbedding, OA, SA
...
class PCT_no_embedding(nn.Module):
    def __init__(self, channels=256):
        super().__init__()
        self.oa1 = OA(channels)
        self.oa2 = OA(channels)
        self.oa3 = OA(channels)
        self.oa4 = OA(channels)
...
class Classification(nn.Module):
    def __init__(self, num_categories=40):
        ...
        self.linear1 = nn.Linear(1024, num_categories, bias=False)
